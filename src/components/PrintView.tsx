      ...
      >
        ...
        <div className="print-page">
          ...
          <div className="bg-[#FAFAFA] border border-[#E5E5E5] rounded-lg p-6">
            <h3 className="text-sm font-semibold uppercase tracking-wide text-[#666666] mb-4">
              Key Findings
            </h3>
          ...
          {/* Page Footer */}
          <footer className="absolute bottom-8 left-0 right-0 px-8 flex justify-between text-xs text-[#AAAAAA] font-mono">
        ...
        <div className="print-page page-break-before">
          <header className="flex justify-between items-center mb-8 pb-4 border-b border-[#E5E5E5]">
            ...
            <span className="text-xs text-[#888888] font-mono">{domain}</span>
          </header>
        ...
        <div className="print-page page-break-before">
          <header className="flex justify-between items-center mb-8 pb-4 border-b border-[#E5E5E5]">
            <span className="text-sm font-medium">AI Visibility Analysis</span>
            <span className="text-xs text-[#888888] font-mono">{domain}</span>
          </header>
        ...
        <div className="print-page page-break-before">
          ...
          <div className="space-y-6 mb-12">
            {(suggestions.suggestions?.length > 0
              ...
              : generateDefaultRecommendations(results, seoScore, llmScore)
